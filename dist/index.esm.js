...
import { useTheme, Box, CircularProgress, Paper, Typography, Link, IconButton, makeStyles, createStyles, AppBar, Container, Toolbar, Breadcrumbs, Button, createMuiTheme, responsiveFontSizes, ThemeProvider, Dialog, DialogTitle, DialogContent, DialogActions } from '@material-ui/core';
import CookieConsent from 'react-cookie-consent';
import { AiOutlineReload, AiOutlineQuestionCircle } from 'react-icons/ai';
import { Redirect, Link as Link$1, useHistory } from 'react-router-dom';
import { Helmet } from 'react-helmet';
import { assertEx, getApiStage, delay } from '@xyo-network/sdk-xyo-js';
...
const BusyBox = (props) => {
    ...
    return (jsxs(Box, Object.assign({ position: "relative" }, boxProps, { children: [children, busy ? (jsx(Box, Object.assign({ display: "flex", bgcolor: props.bgcolor ?? theme.palette.background.default, flexGrow: 1, position: "absolute", left: 0, right: 0, top: 0, bottom: 0, justifyContent: "center", alignItems: "center", style: { opacity: busyOpacity }, zIndex: 1000 }, { children: jsx(CircularProgress, { size: busySize }, void 0) }), void 0)) : null] }), void 0));
};
...
const PaperBox = (props) => {
    ...
    return (jsxs(Paper, Object.assign({}, rootProps, { children: [children, busy ? (jsx(Box, Object.assign({ display: "flex", bgcolor: props.bgcolor ?? theme.palette.background.paper, flexGrow: 1, position: "absolute", left: 0, right: 0, top: 0, bottom: 0, justifyContent: "center", alignItems: "center", style: { opacity: busyOpacity }, zIndex: 1000 }, { children: jsx(CircularProgress, { size: busySize }, void 0) }), void 0)) : null] }), void 0));
};

const FlexPaper = (props) => {
    return jsx(PaperBox, Object.assign({ display: "flex" }, props), void 0);
};
const FlexPaperCol = (props) => {
    return jsx(PaperBox, Object.assign({ display: "flex", flexDirection: "column" }, props), void 0);
};
const FlexGrowPaper = (props) => {
    return jsx(FlexPaper, Object.assign({ flexGrow: 1 }, props), void 0);
};
const FlexGrowPaperCol = (props) => {
    return jsx(FlexPaperCol, Object.assign({ flexGrow: 1 }, props), void 0);
};
...
const CustomCookieConsent = () => {
    const theme = useTheme();
    return (jsx(CookieConsent, Object.assign({ buttonStyle: {
            ...
            flexWrap: 'none',
            zoom: 0.75,
        } }, { children: jsx(FlexGrowRow, { children: jsxs(Typography, Object.assign({ variant: "body2" }, { children: ["This site uses", ' ', jsx(Link, Object.assign({ href: "https://cookiesandyou.com/", rel: "noopener noreferrer", target: "_blank" }, { children: "cookies" }), void 0), ' ', "and", ' ', jsx(Link, Object.assign({ href: "https://policies.google.com/technologies/partner-sites", rel: "noopener noreferrer", target: "_blank" }, { children: "Google\u00A0tools" }), void 0), ' ', "to analyze traffic and for ads measurement purposes."] }), void 0) }, void 0) }), void 0));
};

const ErrorViewer = (props) => {
    const { error, ...boxProps } = props;
    const theme = useTheme();
    return (jsxs(FlexCol, Object.assign({ color: theme.palette.error.main }, boxProps, { children: [jsx(Typography, Object.assign({ align: "center", variant: "subtitle1" }, { children: error?.name }), void 0),
            jsx(Typography, Object.assign({ align: "center", variant: "body2" }, { children: error?.message }), void 0)] }), void 0));
};

const ErrorsViewer = (props) => {
    const { onRetry, errors, ...boxProps } = props;
    return (jsxs(FlexGrowCol, Object.assign({ padding: 1 }, boxProps, { children: [errors?.map((error, index) => {
...
const CoverProgress = (props) => {
    ...
    const theme = useTheme();
    if (open) {
        return (jsx(FlexGrowRow, Object.assign({ position: "absolute", margin: -1, top: 0, bottom: 0, right: 0, left: 0, bgcolor: paper ? theme.palette.background.paper : theme.palette.background.default }, { children: (errors?.length ?? 0) === 0 ? (jsx(CircularProgress, { style: { opacity } }, void 0)) : (jsx(ErrorsViewer, { margin: 1, errors: errors, onRetry: onRetry }, void 0)) }), void 0));
    }
    return null;
};
...
const RedirectWithQuery = (props) => {
    ...
    return jsx(Redirect, Object.assign({}, props, { to: to }), void 0);
};
...
const AppBarEx = (props) => {
    ...
    const theme = useTheme();
    const AppBarExInner = () => {
        return (jsxs(FlexGrowRow, Object.assign({ justifyContent: "space-between" }, { children: [contextToolbar ?? jsx(Toolbar, {}, void 0),
                systemToolbar ?? jsx(Toolbar, {}, void 0)] }), void 0));
    };
    return (jsx(AppBar, Object.assign({ position: "static", style: {
            backgroundColor: theme.palette.background.paper,
            color: theme.palette.text.primary,
            display: 'flex',
            ...style,
        } }, appbarProps, { children: container ? (jsx(Container, Object.assign({ maxWidth: container }, { children: jsx(AppBarExInner, {}, void 0) }), void 0)) : (jsx(AppBarExInner, {}, void 0)) }), void 0));
};

const BasePage = (props) => {
    const { children, beta, container, hideFooter, appFooter, appBar, noindex = false, title, ...baseProps } = props;
    const theme = useTheme();
    return (jsxs(FlexCol, Object.assign({ justifyContent: "flex-start", color: theme.palette.text.primary, alignItems: "stretch", width: "100vw", minHeight: "100vh" }, baseProps, { children: [jsx(Helmet, Object.assign({ title: title }, { children: noindex ? jsx("meta", { content: "noindex", name: "robots" }, void 0) : null }), void 0), appBar, beta ? (jsx(FlexRow, Object.assign({ margin: 1 }, { children: jsx(Typography, Object.assign({ variant: "body1" }, { children: "Important: This page is a Beta page. It is possible that some information may not be correct." }), void 0) }), void 0)) : null,
            container ? (jsx(Container, Object.assign({ component: FlexGrowCol, maxWidth: container, alignItems: "stretch" }, { children: children }), void 0)) : (children),
            hideFooter ? null : jsx("footer", { children: appFooter }, void 0)] }), void 0));
};
...
const BreadcrumbToolbar = (props) => {
    ...
    return (jsx(FlexRow, Object.assign({ marginY: 1, justifyContent: "flex-start" }, boxProps, { children: jsx(Breadcrumbs, Object.assign({ "aria-label": "breadcrumb", separator: "|" }, { children: pathParts.map((_pathPart, index) => {
                const path = getPartialPath(pathParts, index);
                return (jsx(Link, Object.assign({ title: index > 0 ? titles[index - 1] : 'COIN', color: index === pathParts.length - 1 ? 'textPrimary' : 'inherit', component: Link$1, to: path }, { children: index > 0 ? (titles[index - 1]) : (jsx(FlexRow, { children: typeof logo === 'string' ? jsx("img", { src: logo }, void 0) : logo }, void 0)) }), path));
            }) }), void 0) }), void 0));
};
...
const ButtonEx = (props) => {
    ...
    return jsx(Button, Object.assign({ onClick: localOnClick }, rootProps), void 0);
};

const Experiment = (props) => {
    return jsx(Box, Object.assign({}, props), void 0);
};
...
const InvertableThemeProvider = (props) => {
    ...
    return (jsx(InvertableThemeContext.Provider, Object.assign({ value: { options } }, { children: jsx(ThemeProvider, Object.assign({ theme: theme }, { children: children }), void 0) }), void 0));
};

const LinkToEx = (props) => {
    const { to, ...rootProps } = props;
    return jsx(Link, Object.assign({ component: Link$1, to: to }, rootProps), void 0);
};
...
const ErrorDialogOpen = (props) => {
    ...
    return (jsxs(Dialog, Object.assign({ onClose: onClose, open: !!error }, { children: [jsx(DialogTitle, { children: title }, void 0),
            jsx(DialogContent, { children: jsx(FlexRow, { children: jsx(Typography, Object.assign({ color: "error" }, { children: axiosError ? `${message} [${axiosError?.code ?? 'Connection Failure'}]` : `${message}` }), void 0) }, void 0) }, void 0),
            jsx(DialogActions, { children: jsxs(FlexRow, Object.assign({ justifyContent: "space-between", width: "100%", minWidth: "300px" }, { children: [jsx(ButtonEx, Object.assign({ onClick: onCloseClicked, variant: "text" }, { children: "Close" }), void 0),
                        jsx(ButtonEx, Object.assign({ onClick: onRetryClicked, variant: "text" }, { children: "Retry" }), void 0)] }), void 0) }, void 0)] }), void 0));
};
const ErrorDialog = (props) => {
    const { error } = props;
    if (error) {
        return jsx(ErrorDialogOpen, Object.assign({}, props), void 0);
    }
    else {
        return null;
    }
...
const MessageDialogOpen = (props) => {
    ...
    return (jsxs(Dialog, Object.assign({ onClose: onClose, open: open }, { children: [jsx(DialogTitle, { children: title }, void 0),
            jsx(DialogContent, { children: jsx(Box, Object.assign({ display: "flex", flexDirection: "column" }, { children: jsx(Box, Object.assign({ display: "flex", width: "100%" }, { children: children }), void 0) }), void 0) }, void 0),
            jsx(DialogActions, { children: jsxs(Box, Object.assign({ display: "flex", width: "100%" }, { children: [jsx(Box, { children: jsx(Button, Object.assign({ onClick: onCloseClicked, variant: "text" }, { children: "Close" }), void 0) }, void 0),
                        jsx(Box, { flexGrow: 1 }, void 0),
                        jsx(Box, { children: jsx(Button, Object.assign({ onClick: onCloseClicked, variant: "text" }, { children: "Ok" }), void 0) }, void 0)] }), void 0) }, void 0)] }), void 0));
};
const MessageDialog = (props) => {
    const { open } = props;
    if (open) {
        return jsx(MessageDialogOpen, Object.assign({}, props), void 0);
    }
    else {
        return null;
    }
...
const QuickTipButton = (props) => {
    ...
    return (jsxs(IconButton, Object.assign({ onClick: () => setMessageOpen(true), size: "small" }, { children: [jsx(AiOutlineQuestionCircle, { size: 16 }, void 0),
            jsx(MessageDialog, Object.assign({ onClose: () => setMessageOpen(false), open: messageOpen, title: title }, { children: jsx(Typography, Object.assign({ variant: "body1" }, { children: children }), void 0) }), void 0)] }), void 0));
};

export { ActionStatusType$1 as ActionStatusType, AppBarEx, BasePage, BreadcrumbToolbar, BusyBox, ButtonEx, ContactPointOption$1 as ContactPointOption, CustomCookieConsent as CookieConsent, CoverProgress, CustomEvent$3 as DripCustomEvent, StandardEvents as DripStandardEvents, ErrorDialog, Experiment, Experiments, CustomEvent$2 as FacebookCustomEvent, FacebookStandardEvents, Fbq, FlexCol, FlexGrowCol, FlexGrowPaper, FlexGrowPaperCol, FlexGrowRow, FlexPaper, FlexPaperCol, FlexRow, BaseEvent$2 as GoogleBaseEvent, CustomEvent$1 as GoogleCustomEvent, GoogleStandardEvents, Gtag, Gtm, HoverScale, InvertableThemeProvider, ItemAvailability$1 as ItemAvailability, LinkToEx, MapCategoryType$1 as MapCategoryType, MessageDialog, NumberStatus, PaperBox, QuickTipButton, RedirectWithQuery, RichResult, SnapTr, SnapchatStandardEvents, CustomEvent as TiktokCustomEvent, TiktokStandardEvents, Ttq, UniqueUserId, UtmFields, enableProfileLogging, get as getApiStage, getLocalStorageObject, isLocalhost, profileBlock, profileResults, setLocalStorageObject, useAsyncEffect };
