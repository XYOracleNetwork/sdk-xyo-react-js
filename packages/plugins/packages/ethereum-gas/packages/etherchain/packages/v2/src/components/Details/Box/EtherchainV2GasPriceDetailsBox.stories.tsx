...
} as ComponentMeta<typeof EtherchainV2GasPriceDetailsBox>

const Template: ComponentStory<typeof EtherchainV2GasPriceDetailsBox> = (args) => <EtherchainV2GasPriceDetailsBox {...args} />
