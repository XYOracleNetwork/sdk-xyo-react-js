...
import {
  GasPriceHeaderActionsBox, GasPriceHeaderTypography, StyledGasPriceHeaderBox,
...
export const GasPriceHeaderBox: React.FC<GasPriceHeaderBoxProps> = ({
  timestamp, baseFee, heading, ...props
}) => {
  return (
